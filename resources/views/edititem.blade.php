...
@section('content')
    <div class="container">
        <form action="{{route('edit.item', ['id' => $item->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('text') is-invalid @enderror" name="description" id="description" rows="3">{{ $item->description }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
